        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureURL = table.Column<string>(type: "nvarchar(175)", maxLength: 175, nullable: true),
                    TrailerURL = table.Column<string>(type: "nvarchar(175)", maxLength: 175, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "Hulk", "Bruce Banner", "Male", "https://upload.wikimedia.org/wikipedia/en/thumb/3/3b/Mark_Ruffalo_as_%22Professor_Hulk%22.jpeg/200px-Mark_Ruffalo_as_%22Professor_Hulk%22.jpeg" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Derek Kolstad", 1, "Action, Crime, Drama, Thriller", "https://filmyhotspot.com/wp-content/uploads/2020/12/39e611e5-870c-4c6d-97a1-e7c9ee51a97b.jpg", 2023, "John Wick: Chapter 4", "https://www.youtube.com/watch?v=gy31U2bvVGU" },
                    { 2, "Russo", 2, "Action, Drama, Romace", "https://m.media-amazon.com/images/M/MV5BMzA2NDkwODAwM15BMl5BanBnXkFtZTgwODk5MTgzMTE@._V1_.jpg", 2014, "Captain America: The Winter Soldier", "https://www.youtube.com/watch?v=tbayiPxkUMM" },
                    { 3, "Russo", 2, "Action, Drama", "https://m.media-amazon.com/images/M/MV5BMzA2NDkwODAwM15BMl5BanBnXkFtZTgwODk5MTgzMTE@._V1_.jpg", 2016, "Captain America: Civil War", "https://www.youtube.com/watch?v=tbayiPxkUMM" },
                    { 4, "Russo", 2, "Action, Comedy, Drama, Romance", "https://m.media-amazon.com/images/M/MV5BMjMxNjY2MDU1OV5BMl5BanBnXkFtZTgwNzY1MTUwNTM@._V1_.jpg", 2018, "Avengers: Infinity War", "https://www.youtube.com/watch?v=QwievZ1Tx-8" }
                });
